    ...
    public static BlockPattern createPattern(MultiblockMachineDefinition definition) {
        return FactoryBlockPattern.start()
                ...
                .where('G', Predicates.blocks(PollutionMagicBlocks.TERRA_WATERTIGHT_CASING.get())
                        .or(Predicates.abilities(PartAbility.INPUT_ENERGY).setMaxGlobalLimited(23))
                        .or(Predicates.abilities(PartAbility.MAINTENANCE).setMaxGlobalLimited(1))
                        .or(Predicates.abilities(PartAbility.MUFFLER).setMaxGlobalLimited(1))
                        .or(Predicates.abilities(PartAbility.IMPORT_ITEMS).setMaxGlobalLimited(23))
                        .or(Predicates.abilities(PartAbility.EXPORT_ITEMS).setMaxGlobalLimited(23))
                        .or(Predicates.abilities(PartAbility.IMPORT_FLUIDS).setMaxGlobalLimited(23))
                        .or(Predicates.abilities(PartAbility.EXPORT_FLUIDS).setMaxGlobalLimited(23)))
